...
const researchSchema = new Schema<IResearch>(
  {
    ...
    category: { type: String, enum: Object.values(CategoryType), required: true },
    research_type: { type: String, required: true },
    title: { type: String, required: true },
    link: { type: String, required: true },
    progress: { type: String, enum: Object.values(progressStatus), required: true },
    challenge: { type: String, required: false },
    status: { type: String, enum: Object.values(statusResearch), default: "pending" },
  },
  { timestamps: true }
);
